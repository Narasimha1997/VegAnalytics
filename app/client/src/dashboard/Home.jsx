            ...
            <div>
                <Card style = {{margin : '20px auto'}}>
                    <div style = {{padding : '20px', textAlign : 'left'}}>
                        ...
                        <Divider />
                        <a target = "__blank" href = "/export/products.csv"><Button variant = "contained" color = "primary">Download Products</Button></a>
                        <a target = "__blank" href = "/export/transactions.csv"><Button variant = "contained" color = "primary">Download Transactions</Button></a>
                    </div>
                </Card>
            </div>
        )
